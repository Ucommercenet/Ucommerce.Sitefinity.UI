<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CatalogManagerWrapper.ascx.cs" Inherits="UCommerce.Web.Shell.Sitefinity.CatalogManagerWrapper" %>
...
<iframe id="ucommerceIFrame" src="/ucommerce/shell/CatalogManager.aspx" style="width: 100%; border: 0"></iframe>