app.config(function ($routeProvider) {
	$routeProvider
		...
		// Dashboard
		//
		.when('/Vue/index.html#dashboard', {
			redirectTo: function () {
				return buildUrl(`Vue/index.html#/dashboard`);
			}
		})
		.when('/Vue/index.html#stores', {
			redirectTo: function () {
				return buildUrl(`Vue/index.html#/stores`);
			}
		})
		//
		// Catalog
		//
		.when('/Vue/index.html#campaigns', {
			redirectTo: function () {
			return buildUrl(`Vue/index.html#/campaigns`);
			}
		})
		.when('/Vue/index.html#campaigns/:campaignGuid/promotions/:promotionGuid', {
			redirectTo: function (routeParams) {
				return buildUrl(`Vue/index.html#/campaigns/${routeParams.campaignGuid}/promotions/${routeParams.promotionGuid}`)
			}
		}).
		when('/Vue/index.html#campaigns/:campaignGuid/promotions/new', {
			redirectTo: function (routeParams) {
				return buildUrl(`Vue/index.html#/campaigns/${routeParams.campaignGuid}/promotions/new`)
			}
		})
		.when('/Vue/index.html#catalogs', {
			redirectTo: function () {
				return buildUrl(`Vue/index.html#/catalogs`);
			}
		})
		.when('/Vue/index.html#products', {
			redirectTo: function () {
				return buildUrl(`Vue/index.html#/products`);
			}
		})
