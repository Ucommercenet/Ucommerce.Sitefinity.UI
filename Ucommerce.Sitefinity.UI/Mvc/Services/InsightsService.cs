...
namespace UCommerce.Sitefinity.UI.Mvc.Services
{
    ...
    {
        void SendCategoryInteraction(Category category, string predicate, string @object);
        void SendCategoryInteraction(Ucommerce.Search.Models.Category category, string predicate, string @object);
        void SendCustomerInteraction(Customer customer, string predicate, string @object);
        void SendInteraction(string predicate, string @object);
        void SendOrderInteraction(PurchaseOrder order, string predicate, string @object);
        void SendProductInteraction(Product product, string predicate, string @object);
    ...
    public class InsightUcommerceService : IInsightUcommerceService
    {
        ...
        public void SendCategoryInteraction(Category category, string predicate, string @object)
        {
        ...
        public void SendCustomerInteraction(Customer customer, string predicate, string @object)
        {
            var interaction = CreateInteractionForBasket(predicate, @object);
            if (interaction == null)
            {
        ...
        public void SendOrderInteraction(PurchaseOrder order, string predicate, string @object)
        {
        ...
        public void SendProductInteraction(Product product, string predicate, string @object)
        {
            var interaction = CreateInteractionForBasket(predicate, @object);
            if (interaction == null)
            {
        ...
        private void AddCategoryInteractions(Interaction interaction, Category category)
        {
            if (interaction == null)
            {
                return;
        ...
        private void AddProductInteractions(Interaction interaction, Product product)
        {
            if (interaction == null)
            {
                return;
            ...
            foreach (var property in product.ProductProperties)
            {
                ...
                */
                ...
                var exceedsHierarchicalMetadataTitleLimit = property.Value.Length > 255;
        ...
        private void AddProductInteractions(Interaction interaction, Ucommerce.Search.Models.Product product)
        {
            ...
            foreach (var property in product.GetUserDefinedFields())
            {
                ...
                */
                ...
                var exceedsHierarchicalMetadataTitleLimit = propertyValue.Length > 255;
                if (exceedsHierarchicalMetadataTitleLimit)
                {
        ...
        private Interaction GetInteractionForOrder(string predicate, string objectName, PurchaseOrder order)
        {
        ...
        private PurchaseOrder SafeGetOrder()
        {
        ...
        private static void AddAddressInteractions(Interaction interaction, IAddress address)
        {
            if (interaction == null)
            {
                return;
        ...
        private static void AddCustomerInteractions(Interaction interaction, Customer customer)
        {
            if (interaction == null)
            {
                return;
        ...
        private static void AddOrderInteractions(Interaction interaction, PurchaseOrder order)
        {
            if (interaction == null)
            {
                return;
        ...
        private static string CalculateHash(string valueToHash)
        {
            ...
            {
                var hash = md5.ComputeHash(Encoding.Default.GetBytes(valueToHash.ToLower()
                    .Trim()));
