...
namespace UCommerce.Sitefinity.UI.Mvc.Model
{
    ...
    public class BasketPreviewModel : IBasketPreviewModel
    {
        ...
        {
            var payment = TransactionLibrary.GetBasket()
                .Payments.First();
        ...
        public virtual BasketPreviewViewModel GetViewModel()
        {
            ...
            InsightUcommerce.SendOrderInteraction(purchaseOrder, "Checkout > Preview order", string.Empty);
        ...
        private string GetNextStepUrl(Guid nextStepId, Guid orderGuid)
        {
            ...
            var pageUrl = UrlResolver.GetAbsoluteUrl(nextStepUrl);
            pageUrl += "?orderGuid=" + orderGuid;
            return pageUrl;
        }
